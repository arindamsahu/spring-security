...
public class HttpSessionSecurityContextRepositoryTests {
	...
	public void saveContextWhenStatelessAuthenticationThenSkipped() {
		...
		SomeStatelessAuthentication authentication = new SomeStatelessAuthentication();
	...
	private static class SomeStatelessAuthentication extends AbstractAuthenticationToken
			implements StatelessAuthentication {
		public SomeStatelessAuthentication() {
			super(null);
		}
